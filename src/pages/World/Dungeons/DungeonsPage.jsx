  ...
  return (
    <main style={{ padding: 24 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: 16 }}>
        {dungeons.map((d) => (
          <Link key={d.id} to={`/world/dungeons/${d.id}`} style={{ textDecoration: "none", color: "inherit", borderRadius: 12, overflow: "hidden", border: "1px solid rgba(255,255,255,0.1)", background: "#121212" }}>
            <div style={{ position: "relative", height: 160, background: `url(${d.headerImage}) center/cover no-repeat`, filter: "brightness(0.9)" }}>
              <div style={{ position: "absolute", inset: 0, background: "linear-gradient(180deg, rgba(0,0,0,0.15) 30%, rgba(0,0,0,0.7) 100%)" }} />
