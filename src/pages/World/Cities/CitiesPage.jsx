  ...
  return (
    <main style={{ padding: 24 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: 16 }}>
        {cities.map((c) => (
          <Link key={c.id} to={`/world/cities/${c.id}`} style={{ textDecoration: "none", color: "inherit", borderRadius: 12, overflow: "hidden", border: "1px solid rgba(255,255,255,0.1)", background: "#121212" }}>
            <div style={{ position: "relative", height: 160, background: `url(${c.panorama}) center/cover no-repeat` }}>
              ...
              <div style={{ position: "absolute", bottom: 8, left: 12, right: 12, display: "flex", alignItems: "center", gap: 8 }}>
                <img src={c.flag} alt="flag" style={{ width: 28, height: 28, objectFit: "contain" }} />
                <div>
