      ...
      >
        {npcs.map((n) => (
          <Link
            ...
            style={{ textDecoration: "none", color: "inherit", borderRadius: 12, overflow: "hidden", border: "1px solid rgba(255,255,255,0.1)", background: "#121212" }}
          >
            <div style={{ position: "relative", height: 160, background: `url(${n.banner}) center/cover no-repeat` }}>
            ...
            <div style={{ padding: 12, display: "flex", gap: 8, alignItems: "center" }}>
              <img src={n.symbol} alt="symbol" style={{ width: 24, height: 24, objectFit: "contain", opacity: 0.9 }} />
