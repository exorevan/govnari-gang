    ...
    <main style={{ minHeight: "100%" }}>
      ...
      >
        ...
        <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "flex-end" }}>
          <div style={{ padding: "32px", width: "100%", display: "flex", alignItems: "flex-end", justifyContent: "space-between", gap: 16 }}>
            <div>
              <h1 style={{ fontSize: 48, margin: 0, color: "#d4af37" }}>{pc.name}</h1>
            ...
            <img src={pc.symbol} alt="symbol" style={{ width: 96, height: 96, objectFit: "contain" }} />
          </div>
        </div>
      </section>

      {/* Content */}
      <section style={{ display: "grid", gridTemplateColumns: "minmax(0,1fr) 360px", gap: 24, padding: 24 }}>
        <div>
          ...
          <ListBlock title="Достижения" items={pc.achievements} icon="/images/icons/trophy-gold.png" />
          <ListBlock title="Важные моменты в кампании" items={pc.campaignMoments} />
          {pc.gallery?.length ? (
