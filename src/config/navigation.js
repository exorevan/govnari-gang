const navigation = [
	{ label: 'Главная', path: '/' },
	{ label: 'Персонажи', path: '/characters', children: [
	...
	{ label: 'Хроники', path: '/chronicles', children: [
