export const sessions = [
  {
    ...
    participants: [
      { id: "pc-auren", name: "Аурен", portrait: "/images/chars/auren_portrait.jpg" },
      { id: "pc-lyria", name: "Лирия", portrait: "/images/chars/lyria_portrait.jpg" },
    ],
    details:
    ...
    decisions: ["Защитить мирных вместо контратаки", "Сжечь склады, чтобы не достались врагу"],
  ...
  },
  {
    ...
    keyMoments: ["Разговор с призрачным хранителем", "Обвал и спасение свитков"],
    decisions: ["Взять печать, оставив часть свитков", "Не вступать в бой с хранителем"],
    consequences: ["Враждебность духов усилилась", "Ключ к разгадке ритуала получен"],
    mvp: "Лирия Тенепеснь",
