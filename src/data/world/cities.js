export const cities = [
  {
    ...
    info: {
      population: 68000,
      ruler: { name: "Маркиз Ладис Вердий", portrait: "/images/chars/ladis_portrait.jpg" },
      ruleType: "Олигархия",
    ...
    districts: [
      { name: "Старый Порт", description: "Сердце торговли и таверн", icon: "/images/icons/anchor.png" },
      { name: "Шёлковый Ряд", description: "Рынки тканей и специй", icon: "/images/icons/silk.png" },
    ],
    buildings: [
      { name: "Таверна 'Солёный Кот'", image: "/images/world/cities/verdis_tavern.jpg" },
      { name: "Храм Семи Ветров", image: "/images/world/cities/verdis_temple.jpg" },
    ],
    places: ["Смотровая башня", "Сад звездочёта"],
    npcs: [
      { id: "npc-velka", name: "Велка Угольная", role: "Алхимик", portrait: "/images/chars/velka_portrait.jpg" },
      { id: "npc-morvan", name: "Морван Железноликий", role: "Капитан стражи", portrait: "/images/chars/morvan_portrait.jpg" },
    ],
  ...
  },
  {
    ...
    districts: [
      { name: "Зерновые Поля", description: "Амбары и рынки", icon: "/images/icons/grain.png" },
      { name: "Стекольный Квартал", description: "Мастерские стеклоделов", icon: "/images/icons/glass.png" },
    ],
    buildings: [
      { name: "Великий Собор", image: "/images/world/cities/solarn_cathedral.jpg" },
      { name: "Ратуша", image: "/images/world/cities/solarn_hall.jpg" },
    ],
    places: ["Сад рассветов", "Базар паломников"],
    npcs: [
      { id: "pc-auren", name: "Аурен Златоклинок", role: "Паладин", portrait: "/images/chars/auren_portrait.jpg" },
      { id: "pc-lyria", name: "Лирия Тенепеснь", role: "Бард", portrait: "/images/chars/lyria_portrait.jpg" },
    ],
